        ...
        <div className="p-10">
          <form className="space-y-5">
            ...
            <div>
              ...
              <input
                className="border-warning border bg-transparent outline-none w-full p-3 rounded text-black font-semibold"
                type="email"
                name="email"
                id=""
          ...
          <div className="mt-10 space-y-10">
            ...
            <p className="text-center">
              ...
              <Link className="text-warning">Create free account</Link>
            </p>
          </div>
        </div>
      </div>
